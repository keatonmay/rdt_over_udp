...
def perfTest():
	...
	# SR
	h1.cmd('python3 SRrcvr_mininet.py -i %s > SR_r.out &' %h1.IP())
	h2.cmd('python3 SRsndr_mininet.py -i %s > SR_s.out &' %h1.IP())
	# GBN
	#h1.cmd('python3 GBNrcvr_mininet.py -i %s > GBN_r.out &' %h1.IP())
	#h2.cmd('python3 GBNsndr_mininet.py -i %s > GBN_s.out &' %h1.IP())
